...
namespace IGenMain
{
	class MainClass: IASContext
	{
		...
		public ASMemberList FindPackage(string folder, bool completeContent)
		{
			return null;
		}
		...
		public ASClass UpdateClass(ASClass aClass)
		{
			return aClass;
		}
		...
		public static int Main(string[] args)
		{
			...
			if (args.Length < 2)
			{
				Console.WriteLine("IGen 1.0beta - Intrinsic Classes Generator for ActionScript");
				Console.WriteLine("Copyright (c) 2005-2006 Philippe Elsass");
				Console.WriteLine("");
			...
			if (srcPath == destPath)
			{
				Console.WriteLine("Error: <source path> and <dest path> must be different");
				return 2;
			}
