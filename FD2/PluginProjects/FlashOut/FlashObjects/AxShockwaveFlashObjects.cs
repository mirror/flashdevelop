...
using ShockwaveFlashObjects=Interop.ShockwaveFlashObjects;
...
namespace AxShockwaveFlashObjects {
    ...
    public class AxShockwaveFlash : System.Windows.Forms.AxHost {
        ...
        public virtual System.Double TGetPropertyAsNumber(string target, int property) {
            if ((this.ocx == null)) {
        ...
        public virtual System.Double TGetPropertyNum(string target, int property) {
            if ((this.ocx == null)) {
        ...
        public virtual void TSetPropertyNum(string target, int property, System.Double value) {
            if ((this.ocx == null)) {
