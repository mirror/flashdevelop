...
namespace ProjectExplorer.ProjectBuilding
{
	...
	class SwfmillLibraryWriter : XmlTextWriter
	{
		Project project;
		...
		{
			WriteStartDocument();
			WriteComment("Swfmill library for project " + project.Name + " generated by FDBuild");
			WriteComment("============");
			WriteComment("This file was generated by a tool.");
			WriteComment("Any modifications you make may be lost.");
			WriteStartElement("movie");
			WriteAttributeString("version", project.MovieOptions.Version.ToString());
			...
			WriteAttributeString("framerate", project.MovieOptions.Fps.ToString());
				...
				WriteStartElement("frame");
					WriteStartElement("library");
						...
						WriteAttributeString("id","__sharepoint__");
						WriteEndElement();
						WritePreloaders();
						if (!NeedsMoreFrames) 
							WriteNormalAssets();
		...
		private void WriteSharedClips()
		{
			...
			foreach (LibraryAsset asset in project.LibraryAssets)
				...
				{
					WriteStartElement("place");
					WriteAttributeString("id","__importtag__");
