		...
		*/
		private Rectangle ContentRectangle
		{
			get
			{
				...
				int x = rectWindow.X +2;
				int y = rectWindow.Y + (rectCaption.IsEmpty ? 0 : rectCaption.Height) +
					(DockState == DockState.Document ? rectTabStrip.Height : 0)+2;
				int width = rectWindow.Width-2;
				int height = rectWindow.Height - rectCaption.Height - rectTabStrip.Height-2;
