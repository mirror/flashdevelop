package flash.display
{
	 ...
	 */
	[Event(name="rollOver", type="flash.events.MouseEvent.ROLL_OVER")] 

	/**
	 * Dispatched when the user moves a pointing device away from an InteractiveObject instance.
	 * @eventType flash.events.MouseEvent.ROLL_OUT
	 */
	[Event(name="rollOut", type="flash.events.MouseEvent.ROLL_OUT")] 
	 ...
	 */
	[Event(name="mouseWheel", type="flash.events.MouseEvent.MOUSE_WHEEL")] 
	 ...
	 */
	[Event(name="mouseUp", type="flash.events.MouseEvent.MOUSE_UP")] 
	 ...
	 */
	[Event(name="mouseOver", type="flash.events.MouseEvent.MOUSE_OVER")] 

	/**
	 * Dispatched when the user moves a pointing device away from an InteractiveObject instance.
	 * @eventType flash.events.MouseEvent.MOUSE_OUT
	 */
	[Event(name="mouseOut", type="flash.events.MouseEvent.MOUSE_OUT")] 
	 ...
	 */
	[Event(name="mouseMove", type="flash.events.MouseEvent.MOUSE_MOVE")] 
	 ...
	 */
	[Event(name="mouseDown", type="flash.events.MouseEvent.MOUSE_DOWN")] 
	 ...
	 */
	[Event(name="doubleClick", type="flash.events.MouseEvent.DOUBLE_CLICK")] 
	 ...
	 */
	[Event(name="mouseFocusChange", type="flash.events.FocusEvent.MOUSE_FOCUS_CHANGE")] 
	 ...
	 */
	[Event(name="keyFocusChange", type="flash.events.FocusEvent.KEY_FOCUS_CHANGE")] 

	/**
	 * Dispatched after a display object loses focus.
	 * @eventType flash.events.FocusEvent.FOCUS_OUT
	 */
	[Event(name="focusOut", type="flash.events.FocusEvent.FOCUS_OUT")] 

	/**
	 * Dispatched after a display object gains focus.
	 * @eventType flash.events.FocusEvent.FOCUS_IN
	 */
	[Event(name="focusIn", type="flash.events.FocusEvent.FOCUS_IN")] 
	 ...
	 */
	[Event(name="selectAll", type="flash.events.Event.SELECT_ALL")] 
	 ...
	 */
	[Event(name="paste", type="flash.events.Event.PASTE")] 
	 ...
	 */
	[Event(name="cut", type="flash.events.Event.CUT")] 
