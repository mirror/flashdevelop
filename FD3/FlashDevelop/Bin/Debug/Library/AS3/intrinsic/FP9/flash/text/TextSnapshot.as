package flash.text
{
	...
	public class TextSnapshot extends Object
	{
		...
		public function getText (beginIndex:int, endIndex:int, includeLineEndings:Boolean) : String;
		...
		public function hitTestTextNearPos (x:Number, y:Number, maxDistance:Number) : Number;

		/// Specifies the color to use when highlighting characters that have been selected with the  setSelected() method.
		public function setSelectColor (hexColor:uint) : void;
