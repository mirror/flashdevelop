package flash.display
{
	...
	public class DisplayObject extends flash.events.EventDispatcher
	{
		...
		/// [FP10] Indicates the z coordinate position along the z-axis of the DisplayObject instance relative to the 3D parent container.
		public var z:Number;
		...
		/// [FP10] Indicates the depth scale (percentage) of an object as applied from the registration point of the object.
		...
		/// [FP10] Converts a two-dimensional point from the Stage (global) coordinates to a three-dimensional display object's (local) coordinates.
		public function globalToLocal3D(point:flash.geom.Point):flash.geom.Vector3D;

		/// [FP10] Converts a three-dimensional point of the three-dimensional display object's (local) coordinates to a two-dimensional point in the Stage (global) coordinates.
		public function local3DToGlobal(point3d:flash.geom.Vector3D):flash.geom.Point;
