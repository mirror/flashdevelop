package flash.system
{
	...
	{
		/// [AIR] The file is running in an AIR application, and it was installed with the package (the AIR file) for that application.
		public static const APPLICATION : String;
