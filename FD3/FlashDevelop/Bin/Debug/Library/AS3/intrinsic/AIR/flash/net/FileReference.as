package flash.net
{
	...
	public class FileReference extends flash.events.EventDispatcher
	{
		...
		/// [FP10] Starts the load of a local file.
		public function load():void;

		/// [FP10] Opens a dialog box that lets the user save a file to the local filesystem.
		public function save(data:*, defaultFileName:String=null):void;

		/// [AIR] Starts the upload of a file to a remote server without encoding.
		public function uploadUnencoded(request:flash.net.URLRequest):void;
