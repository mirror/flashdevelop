package flash.geom
{
	...
	public class Matrix
	{
		...
		public function concat(m:flash.geom.Matrix):void;
		...
		public function deltaTransformPoint(point:flash.geom.Point):flash.geom.Point;

		/// Returns the result of a geometric transformation to a Point object.
		public function transformPoint(point:flash.geom.Point):flash.geom.Point;
