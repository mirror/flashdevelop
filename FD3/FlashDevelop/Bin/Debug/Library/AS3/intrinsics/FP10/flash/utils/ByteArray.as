package flash.utils
{
	...
	public class ByteArray
	{
		...
		/// [FP10] Compresses the byte array using the DEFLATE compression algorithm.
		public function deflate():void;

		/// Decompresses the byte array.
		public function uncompress(algorithm:String=unknown):void;

		/// [FP10] Decompresses the byte array.
		public function inflate():void;

		/// Converts the byte array to a string.
		public function toString():String;

		/// [FP10] Clears the contents of the byte array and resets the length and position properties to 0.
