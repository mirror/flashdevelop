package flash.utils
{
	...
	public class Proxy
	{
		...
		flash_proxy function getProperty(name:*):void;

		/// Overrides a call to change a property's value.
		flash_proxy function setProperty(name:*, value:*):void;

		/// Overrides the behavior of an object property that can be called as a function.
		flash_proxy function callProperty(name:*, ...rest):void;
		...
		flash_proxy function getDescendants(name:*):void;
		...
		flash_proxy function nextValue(index:int):void;
