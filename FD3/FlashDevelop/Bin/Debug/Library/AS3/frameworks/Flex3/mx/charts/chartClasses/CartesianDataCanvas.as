...
package mx.charts.chartClasses {
	...
	public class CartesianDataCanvas extends ChartElement {
		/**
		 ...
		 *
		 * @param child             <DisplayObject> The display object that is to be added as a child to current canvas.
		 * @param left              <* (default = NaN)> Left x-coordinate of the child in data coordinates.
		 * @param top               <* (default = NaN)> Top y-coordinate of the child in data coordinates.
		 * @param right             <* (default = NaN)> Right x-coordinate of the child in data coordinates.
		 * @param bottom            <* (default = NaN)> Bottom y-coordinate of the child in data coordinates.
		 * @param hCenter           <* (default = NaN)> Middle x-coordinate of the child in data coordinates.
		 * @param vCenter           <* (default = NaN)> Middle y-coordinate of the child in data coordinates.
		 */
		 ...
		 *
		 * @param child             <DisplayObject> The display object that is to be updated.
		 * @param left              <* (default = NaN)> Left x coordinate of the child, in data coordinates.
		 * @param top               <* (default = NaN)> Top y coordinate of the child, in data coordinates.
		 * @param right             <* (default = NaN)> Right x coordinate of the child, in data coordinates.
		 * @param bottom            <* (default = NaN)> Bottom y coordinate of the child, in data coordinates.
