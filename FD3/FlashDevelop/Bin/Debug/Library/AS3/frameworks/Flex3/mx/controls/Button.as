 ...
 *    dataChange="<i>No de
     ...
     *  Flags used to save information about the skin and icon styles
		 */
		var checkedDefaultSkin : Boolean;
		var defaultSkinUsesStates : Boolean;
		var checkedDefaultIcon : Boolean;
		var defaultIconUsesStates : Boolean;
		/**
		 *  @private
     *  Skin names.
     *  Allows subclasses to re-define the skin property names.
		 */
		var skinName : String;
		var upSkinName : String;
		var overSkinName : String;
		var downSkinName : String;
		var disabledSkinName : String;
		var selectedUpSkinName : String;
		var selectedOverSkinName : String;
		var selectedDownSkinName : String;
		var selectedDisabledSkinName : String;
		/**
		 *  @private
     *  Icon names.
     *  Allows subclasses to re-define the icon property names.
		 */
		var iconName : String;
		var upIconName : String;
		var overIconName : String;
		var downIconName : String;
		var disabledIconName : String;
		var selectedUpIconName : String;
		var selectedOverIconName : String;
		var selectedDownIconName : String;
		var selectedDisabledIconName : String;
		/**
		 *  @private
		 */
