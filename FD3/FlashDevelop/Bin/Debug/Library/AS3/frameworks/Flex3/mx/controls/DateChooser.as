 ...
 *    textDecoration
     ...
     *  Placeholder for mixin by DateChooserAccImpl.
		 ...
		 *  @private
		 */
		var headerDisplay : UIComponent;
		/**
		 *  @private
     *  The internal UITextField that displays
     *  the currently visible month and year.
		 */
		var monthDisplay : IUITextField;
		/**
		 *  @private
		 */
		var fwdMonthHit : Sprite;
		/**
		 *  @private
		 */
		var backMonthHit : Sprite;
		/**
		 *  @private
		 */
		var upYearHit : Sprite;
		/**
		 *  @private
		 */
		var downYearHit : Sprite;
		/**
		 *  @private
		 */
		var calHeader : UIComponent;
		/**
		 *  @private
		 */
		var yearDisplay : IUITextField;
		/**
		 *  @private
     *  The internal Button which, when clicked,
     *  makes the DateChooser display the next year.
		 */
		var upYearButton : Button;
		/**
		 *  @private
     *  The internal Button which, when clicked,
     *  makes the DateChooser display the previous year.
		 */
		var downYearButton : Button;
		/**
		 *  @private
     *  The internal Button which, when clicked,
     *  makes the DateChooser display the next month.
		 */
		var fwdMonthButton : Button;
		/**
		 *  @private
     *  The internal Button which, when clicked,
     *  makes the DateChooser display the previous month.
		 */
		var backMonthButton : Button;
		/**
		 *  @private
