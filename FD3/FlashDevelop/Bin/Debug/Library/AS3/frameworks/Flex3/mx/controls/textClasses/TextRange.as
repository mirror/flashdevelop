...
package mx.controls.textClasses {
	...
	public class TextRange {
		 ...
		 *
		 * @param owner             <UIComponent> The control that contains the text. The control must have
		 *                            a textField property, or, as is the case of the
		 *                            RichTextEditor control, a textArea property.
		 * @param modifiesSelection <Boolean (default = false)> Whether to select the text in the range.
		 ...
		 * @param beginIndex        <int (default = -1)> Zero-based index of the first character in the range.
		 ...
		 * @param endIndex          <int (default = -1)> Zero-based index of the position after the
