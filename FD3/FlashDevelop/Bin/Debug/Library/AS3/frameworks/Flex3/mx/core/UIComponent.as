 ...
 *  @see mx.core.UIComponent
     ...
     *  commitProperties() method called.
		 */
		var invalidatePropertiesFlag : Boolean;
		/**
		 *  @private
     *  Whether this component needs to have its
     *  measure() method called.
		 */
		var invalidateSizeFlag : Boolean;
		/**
		 *  @private
     *  Whether this component needs to be have its
     *  updateDisplayList() method called.
		 */
		var invalidateDisplayListFlag : Boolean;
		/**
		 *  @private
     ...
     *  of the overlay.
		 */
		var overlayReferenceCount : int;
		/**
		 *  @private
		 */
		var saveBorderColor : Boolean;
		/**
		 *  @private
		 */
     ...
     *
     *  @param ratios 
     *  Specifies the distribution of colors. The num
		 */
 ...
 *  An element of the methodQueue array.
	 */
	private class MethodQueueElement
	{
		/**
