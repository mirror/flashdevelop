...
package mx.managers {
	...
	public class FocusManager implements IFocusManager {
		 ...
		 * Constructor.
		 *
		 * @param container         <IFocusManagerContainer> An IFocusManagerContainer that hosts the FocusManager.
		 * @param popup             <Boolean (default = false)> If true, indicates that the container
