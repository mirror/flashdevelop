 ...
 *  additional state.
	 */
	private class ModifiedCollectionViewCursor extends EventDispatcher implements IViewCursor
	{
		/**
		 *  @private
		 */
 ...
 *  Only the ModifiedCollectionView should construct this.
	 */
	private class ModifiedCollectionViewBookmark extends CursorBookmark
	{
		var index : int;
