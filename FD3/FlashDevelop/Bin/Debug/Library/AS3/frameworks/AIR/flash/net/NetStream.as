...
package flash.net {
	...
	public class NetStream extends EventDispatcher {
		 ...
		 *
		 * @param userName          <String> A valid user name credential.
		 * @param password          <String> The password credential corresponding to the user name provided.
		 * @param type              <String> A string that specifies what type of authentication credentials are provided.
		 *                            Valid values are "drm" and "proxy". The default value is "drm".
		 *                            With "drm" authentication type, the credentials provided are authenticated against
		 *                            Flash Media Rights Management Server (FMRMS).
		 *                            With "proxy" authentication type, the credentials provided are authenticated against
		 *                            the proxy server and must match those required by the proxy server. For example, the "proxy"
		 ...
		 *                            You can use setDRMAuthenticationcredentials() a second time, with "drm" option,
